...
# pylint: disable='undefined-variable','unresolved-import'
...
class _html2text(HTMLParser.HTMLParser):
    ...
    def handle_emphasis(self, start, tag_style, parent_style):
        ...
        if start:
            # crossed-out text must be handled before other attributes in order
            # not to output qualifiers unnecessarily
