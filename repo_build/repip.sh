...
if (( PIP_INT > 2021 )); then
	# As of pip 20.2.2qqqqq
	# 	this is a new option to resolve dependencies
	# 	--use-feature=2020-resolver
	alias pip='$(which pip3) --use-feature=2020-resolver '
	alias piu='$(which pip3) install -U --use-feature=2020-resolver '
else
	alias pip='$(which pip3) '
	alias piu='$(which pip3) install -U '
fi

lime "Installing basic pip tools ... "
piu wheel setuptools twine pytest pylint pre-commit

lime "Installing pip dev tools ... "
...
lime "Updating all python3 packages ... "
