...
# array syntax for either BASH or ZSH -> ${array[@]:0:1}

# That will work for tokens indeed; for those needing words (as split by the shell, i.e. space, newline...) you can use the construct: $array[(w)1] to reference the first element (zsh starts at index 1 by default) and ${(w)#words} to get the number of words. NB zsh only!!


# Reference: ~/.dotfiles/.oh-my-zsh/tools/upgrade.sh
...
DEFAULT_LIST='python macos'

GI_LIST=${@:-$DEFAULT_LIST}
